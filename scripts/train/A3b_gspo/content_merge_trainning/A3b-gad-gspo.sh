...
#     --backend fsdp \
#     --local_dir /home/jovyan/JQ/gad_gspo_B300/models/content-conflict-understanding-A3b-gspo-warmup-fsdp2/global_step_158/actor \
#     --target_dir /home/jovyan/JQ/gad_gspo_B300/models/content-conflict-understanding-A3b-gspo-warmup-fsdp2/global_step_158/actor_merged \
#     --hf_model_path /mnt/public_data/Qwen/Qwen3-30B-A3B-Instruct-2507

# python verl/scripts/legacy_model_merger.py merge \
#     --backend fsdp \
#     --local_dir /home/jovyan/JQ/gad_gspo_B300/models/content-conflict-understanding-A3b-gspo-warmup-fsdp2/global_step_158/critic \
#     --target_dir /home/jovyan/JQ/gad_gspo_B300/models/content-conflict-understanding-A3b-gspo-warmup-fsdp2/global_step_158/critic_merged \
#     --hf_model_path /mnt/public_data/Qwen/Qwen3-8B

actor_model_path="/home/jovyan/JQ/gad_gspo_B300/models/content-conflict-understanding-A3b-gspo-warmup-fsdp2/global_step_158/actor_merged"
critic_model_path="/home/jovyan/JQ/gad_gspo_B300/models/content-conflict-understanding-A3b-gspo-warmup-fsdp2/global_step_158/critic_merged"

backend=fsdp2  # fsdp, fsdp2, megatron
project_name=kowledge_analysis_A3b
experiment_name=content-conflict-understanding-A3b-gspo-gad-$backend
...
clip_ratio_low=1e-3   # 0.1%， 适当增大裁剪范围
clip_ratio_high=2e-3  # 0.2%

actor_lr=1e-6     # 提高学习率，加速 actor 学习
...
max_prompt_length=3750    # core_content 数据集，与 GAD 一致
...
rollout_name=vllm
infer_tp=4
gpu_memory_utilization=0.75  # 降低推理显存占用，为训练留出更多空间
max_model_len=4300   # 修改：1550 + 256 + 256(余量)
