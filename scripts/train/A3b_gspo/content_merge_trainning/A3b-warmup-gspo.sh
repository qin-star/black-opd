...
# ===================================== Model & Experiment =====================================
actor_model_path="/home/jovyan/JQ/gad_gspo_B300/models/merged-1225-A3b-gspo-warmup-fsdp2/global_step_200/actor"  #SFT merge 后的模型
critic_model_path="/home/jovyan/JQ/gad_gspo_B300/models/merged-1225-A3b-gspo-warmup-fsdp2/global_step_200/critic"  # 使用较小的模型作为 Critic

backend=fsdp2  # fsdp, fsdp2, megatron
project_name=kowledge_analysis_A3b
experiment_name=merged-1226-A3b-gspo-warmup-$backend
...
# ===================================== Data/Model =====================================
train_files=/home/jovyan/JQ/gad_gspo_B300/scripts/data_process/trainning_data/reply_generation/processed/reply-merge-1226.parquet
test_files=/home/jovyan/JQ/gad_gspo_B300/scripts/data_process/trainning_data/merged/merged_train_new_test.parquet

max_prompt_length=4000    # core_content 数据集，与 GAD 一致
max_response_length=680   # core_content P99=174，256 足够
...
max_model_len=5000   # 550 + 128 + 128(余量)，与 GAD 一致
